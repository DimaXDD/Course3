...
EXEC Регистрация @Имя = 'Dmitry', @Фамилия = 'Trubach', @Email = 'dima1@mail.ru', @Пароль = 'dima123', @Роль = 'Студент', @Данные = 'Тест 1';
EXEC Регистрация @Имя = 'Prepod', @Фамилия = 'Prepod', @Email = 'dima2@mail.ru', @Пароль = 'dima1234', @Роль = 'Преподаватель', @Данные = 'Тест 2';
EXEC Регистрация @Имя = 'Тестовый', @Фамилия = 'Препод', @Email = 'dima3@mail.ru', @Пароль = 'dima12345', @Роль = 'Преподаватель', @Данные = 'Тест 3';
EXEC Регистрация @Имя = 'admin', @Фамилия = 'admin', @Email = 'dima4@mail.ru', @Пароль = 'dima123456', @Роль = 'Администратор', @Данные = 'Тест 3';
