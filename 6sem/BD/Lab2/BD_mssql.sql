...
-- Добавление теста
EXEC Добавить_тест @ID = 2, @Название = 'Тест №2', @Описание = 'Тестовый', @Предмет = 'Физика', @ID_пользователя = 3;
EXEC Добавить_тест @ID = 3, @Название = 'Тест №3', @Описание = 'Ага да', @Предмет = 'Информатика', @ID_пользователя = 4;

-- Вопросы и ответы
-- Добавление вопросов и ответов для второго теста (ID_теста = 2)
EXEC Добавить_Вопрос
    @ID = 6,
    @Текст = 'Вопрос 1, ответ да',
    @ID_теста = 2,
...
-- Добавление вопросов и ответов для третьего теста (ID_теста = 3)
EXEC Добавить_Вопрос
    @ID = 11,
    @Текст = 'Вопрос 1, ответ да',
    @ID_теста = 3,
