...
public class Entropy {
    ...
    // Энтропия Хартли
    public static double getHartleyEntropy(String alphabet) {
        return Math.log(alphabet.length()) / Math.log(2);
    }
    ...
    public static double getRedundancy(String alphabet, String str) {
        double shannonEntropy = getShannonEntropy(str);
        double hartleyEntropy = getHartleyEntropy(alphabet);
