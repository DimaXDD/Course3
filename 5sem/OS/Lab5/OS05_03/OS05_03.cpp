...
Приложение  OS05_03  должно вывести в свое консольное окно  заданные параметры  и запустить два 
одинаковых дочерних потока(потоковая функция TA), осуществляющих вывод консольное окно и имеющих  заданные в параметрах  приоритеты. */
