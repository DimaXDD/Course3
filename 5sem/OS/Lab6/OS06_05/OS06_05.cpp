...
int main()
{
	...
	processes[0] = createProcess(L"E:\\3course\\5sem\\OS\\Lab6\\Debug\\OS06_05A.exe").hProcess;
	processes[1] = createProcess(L"E:\\3course\\5sem\\OS\\Lab6\\Debug\\OS06_05B.exe").hProcess;
