...
public class BuyWithInCorrectDataPage extends BasePage {
    ...
    public BuyWithInCorrectDataPage(WebDriver driver) {
        super(driver);
        PageFactory.initElements(this.driver, this);
    }

    public void buyingWithInCorrectData(String fioInput,
                                      String phoneInput,
                                      String emailInput,
